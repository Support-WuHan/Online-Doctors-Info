...
| <hr width=100% size=1 ALIGN=CENTER> # | <hr width = "100" size=1 ALIGN=CENTER> 医疗机构名称 </hr> | <hr width = "100%" size=1 ALIGN=CENTER> 网址、微信公众号 </hr> | <hr width = "200" size=1 ALIGN=CENTER> 服务内容（收费情况）</hr> | <hr width = "100%" size=1 ALIGN=CENTER> 添加日期 </hr>  |
|---|--------------|---------------------------|-------------------------------|-----------|
